...
# import torchsnooper
# @torchsnooper.snoop()
def domain_split(dataset, model, device, cluster_before, filename, epoch, nmb_cluster=3, method='Kmeans', pca_dim=256, batchsize=128, num_workers=4, whitening=False, L2norm=False, instance_stat=True,exp_name=None):
    #kmeans,
    ...
    save_tsne=False
    if save_tsne==True and (epoch==10 or epoch==40 or epoch ==55):
