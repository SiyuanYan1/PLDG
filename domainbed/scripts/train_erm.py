...
if __name__ == "__main__":
    ...
    parser.add_argument('--ood_vis', type=bool, default=False)
    ...
    for step in range(start_step, n_steps):
        ...
        """clustering domain-discriminative features """
        # print('AAAAAAAAAAAA',algorithm)
        # print('DDDDDDDDDDDD',dataset)
        # print('DDDDDDDDDDDllllllllllllll',train_loaders)
        if args.clustering:
